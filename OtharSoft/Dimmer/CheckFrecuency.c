...
void TIMFrec_Config(void) {
	...
	timerInitStructure.TIM_Prescaler = 8399; // timer_tick_frequency = 168000000 / 167+1 = 20 KHz --> 50 us
	//Onda de 50Hz -> Semiciclo de 10 ms -> El timer cuenta 200 veces en cada semiciclo
