...
void PLL_init(void) {
	...
	FSMC_WriteReg(0x88, 0x0b); //system clock = 20*(13+1)/1*(2^2)=60MHz
	Delay_ms(20);
	FSMC_WriteReg(0x89, 0x02);
	Delay_ms(20);
...
{
	FSMC_WriteReg_ANDMask(0x01,0xFD); //PWRR
}
...
{
	FSMC_WriteReg(0x01,0x01); //PWRR
    FSMC_WriteData(0x00);// No hay que hacer un writeCmd primero ?
    Delay_ms(1);
}
//																								REG[04h]
/*******************************************************************************
...
{
	FSMC_WriteReg_ORMask(0x04,0x80);//PCSR
}
...
void PCLK_non_inversion(void)
{
	...
	FSMC_WriteReg_ANDMask(0x04,0x7f);//PCSR
}
...
{
    FSMC_WriteReg_ANDORMask(0x04,0x80,setx);//PCSR
}
...
{
   FSMC_WriteReg_ANDMask(0x05,0x7f);//SROC
}
...
{
	FSMC_WriteReg_ORMask(0x05,0x80);//SROC
}
...
{
    FSMC_WriteReg_ANDMask(0x05,0xbf);//SROC
}
...
{
	FSMC_WriteReg_ORMask(0x05,0x40);//SROC
}
...
{
    FSMC_WriteReg_ANDMask(0x05,0xdf);//SROC
}
/*******************************************************************************
...
{
    FSMC_WriteReg_ORMask(0x05,0x20);//SROC
}
/*******************************************************************************
...
{
	FSMC_WriteReg_ANDMask(0x05,0xE7);//SROC
}
...
{
	FSMC_WriteReg_ANDORMask(0x05,0xEF,0x08);//SROC
}
/*******************************************************************************
...
{
	FSMC_WriteReg_ORMask(0x05,0x10);//SROC
}
...
{
	FSMC_WriteReg_ANDMask(0x05,0xFB);//SROC
}
...
{
	FSMC_WriteReg_ORMask(0x05,0x04);//SROC
}
...
{
	FSMC_WriteReg_ANDMask(0x05,0xFD);//SROC
}
...
{
	FSMC_WriteReg_ANDORMask(0x05,0xFE,0x02);//SROC
}
...
{
	FSMC_WriteReg_ORMask(0x05,0x03);//SROC
}
...
{
	FSMC_WriteReg(0x06,CLK_DIV);//SFCLR
}
...
void Color_256(void)
{
	FSMC_WriteReg_ANDMask(0x10,0xF3);//SYSR
}
...
void Color_65K(void)
{
	FSMC_WriteReg_ORMask(0x10,0x08);//SYSR
}
...
{
	FSMC_WriteReg_ANDMask(0x10,0xFC);//SYSR
}
...
{
	FSMC_WriteReg_ORMask(0x10,0x02);//SYSR
}
...
void One_Layer(void)
{
	FSMC_WriteReg_ANDMask(0x20,0x7f);//DPCR
}
...
{
	FSMC_WriteReg_ORMask(0x20,0x80);//DPCR
}
...
{
	FSMC_WriteReg_ANDMask(0x20,0xf7);//DPCR
}
...
{
	FSMC_WriteReg_ORMask(0x20,0x08);//DPCR
}
...
{
	FSMC_WriteReg_ANDMask(0x20,0xfb);//DPCR
}
...
{
	FSMC_WriteReg_ORMask(0x20,0x04);//DPCR
}
...
{
	FSMC_WriteReg_ANDMask(0x21,0x7F);//FNCR0
}
/*******************************************************************************
* Function Name  : CGROM_Font
...
{
	FSMC_WriteReg_ORMask(0x21,0x80);//FNCR0
}
...
{
	FSMC_WriteReg_ANDMask(0x21,0xdf);//FNCR0
}
/*******************************************************************************
...
{
	FSMC_WriteReg_ORMask(0x21,0x20);//FNCR0
}
...
void ISO8859_1(void)
{
	FSMC_WriteReg_ANDMask(0x21,0xFC);//FNCR0
}
...
void ISO8859_2(void)
{
	FSMC_WriteReg_ANDORMask(0x21,0xFD,0x01);//FNCR0
}
...
void ISO8859_3(void)
{
	FSMC_WriteReg_ANDORMask(0x21,0xFE,0x02);//FNCR0
}
/*******************************************************************************
...
void ISO8859_4(void)
{
	FSMC_WriteReg_ORMask(0x21,0x03);//FNCR0
}
...
{
	FSMC_WriteReg_ANDMask(0x22,0x7F);//FNCR1
}
...
{
	FSMC_WriteReg_ORMask(0x22,0x80);//FNCR1
}
...
{
	FSMC_WriteReg_ANDMask(0x22,0xBF);//FNCR1
}
...
{
	FSMC_WriteReg_ORMask(0x22,0x40);//FNCR1
}
...
{
	FSMC_WriteReg_ANDMask(0x22,0xEF);//FNCR1
}
...
{
	FSMC_WriteReg_ORMask(0x22,0x10);//FNCR1
}
...
{
	FSMC_WriteReg_ANDMask(0x22,0xF3);//FNCR1
}
...
{
	FSMC_WriteReg_ANDORMask(0x22,0xF7,0x04);//FNCR1
}
...
{
	FSMC_WriteReg_ANDORMask(0x22,0xFB,0x08);//FNCR1
}
...
{
	FSMC_WriteReg_ORMask(0x22,0x0C);//FNCR1
}
...
{
	FSMC_WriteReg_ANDMask(0x22,0xFC);//FNCR1
}
...
{
	FSMC_WriteReg_ANDORMask(0x22,0xFD,0x01);//FNCR1
}
...
{
	FSMC_WriteReg_ANDORMask(0x22,0xFE,0x02);//FNCR1
}
...
{
	FSMC_WriteReg_ORMask(0x22,0x03);//FNCR1
}
...
{
	FSMC_WriteReg(0x24,X);

	FSMC_WriteReg(0x25,X>>8);

	FSMC_WriteReg(0x26,Y);

	FSMC_WriteReg(0x27,Y>>8);
}
...
{
	FSMC_WriteReg_ANDMask(0x2E,0x3F);//FWTSR
}
...
{
	FSMC_WriteReg_ANDORMask(0x2E,0x7F,0x40);//FWTSR
}
...
{
	FSMC_WriteReg_ORMask(0x2E,0x80);//FWTSR
}
...
void Font_spacing_set(uint8_t setx) //uint8_t[5:0]
{
    ...
    FSMC_WriteReg_ANDORMask(0x2E,0xC0,temp);//FWTSR
}
...
{
	FSMC_WriteReg_ANDMask(0x2F,0x1F);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0x1F,0x20);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0x1F,0x40);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0x1F,0x60);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0x1F,0x80);
}
...
{
	FSMC_WriteReg_ANDMask(0x2F,0xE3);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0xE3,0x04);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0xE3,0x08);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0xE3,0x0C);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0xE3,0x10);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0xE3,0x14);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0XE3,0x18);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0xE3,0x1C);
}
...
{
	FSMC_WriteReg_ANDMask(0x2F,0xFC);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0xFD,0x01);
}
...
{
	FSMC_WriteReg_ANDORMask(0x2F,0xFE,0x02);
}
...
{
	FSMC_WriteReg_ORMask(0x2F,0x03);
}
...
void Active_Window(uint16_t XL,uint16_t XR ,uint16_t YT ,uint16_t YB)
{
	...
	FSMC_WriteReg(0x30,XL); //Horizontal Start Point 0 of Active Window (HSAW0)
	FSMC_WriteReg(0x31,XL>>8); //Horizontal Start Point 1 of Active Window (HSAW1)
	FSMC_WriteReg(0x34,XR); //Horizontal End Point 0 of Active Window (HEAW0)
	FSMC_WriteReg(0x35,XR>>8); //Horizontal End Point 1 of Active Window (HEAW1)

    //setting active window Y
	FSMC_WriteReg(0x32,YT); //Vertical Start Point 0 of Active Window (VSAW0)
	FSMC_WriteReg(0x33,YT>>8); //Vertical Start Point 1 of Active Window (VSAW1)
	FSMC_WriteReg(0x36,YB); //Vertical End Point of Active Window 0 (VEAW0)
	FSMC_WriteReg(0x37,YB>>8); //Vertical End Point of Active Window 1 (VEAW1)
}
...
void Scroll_Window(uint16_t XL,uint16_t XR ,uint16_t YT ,uint16_t YB)
{
	...
	FSMC_WriteReg(0x38,XL);
	FSMC_WriteReg(0x39,XL>>8);

	FSMC_WriteReg(0x3c,XR);
	FSMC_WriteReg(0x3d,XR>>8);

	FSMC_WriteReg(0x3a,YT);
	FSMC_WriteReg(0x3b,YT>>8);

    FSMC_WriteReg(0x3e,YB);
	FSMC_WriteReg(0x3f,YB>>8);
}
...
{
	FSMC_WriteReg_ANDMask(0x40,0x7F);
}
...
void Text_Mode(void)
{
	FSMC_WriteReg_ORMask(0x40,0x80);
}
...
{
	FSMC_WriteReg_ANDMask(0x40,0xBF);
}
...
{
	FSMC_WriteReg_ORMask(0x40,0x40);
}
...
{
	FSMC_WriteReg_ANDMask(0x40,0xDF);
}
...
{
	FSMC_WriteReg_ORMask(0x40,0x20);
}
...
{
	FSMC_WriteReg_ANDMask(0x40,0xF3);
}
...
{
	FSMC_WriteReg_ANDORMask(0x40,0xF3,0x04);
}
...
{
	FSMC_WriteReg_ANDORMask(0x40,0xF3,0x0C);
}
...
{
	FSMC_WriteReg_ANDORMask(0x40,0xF3,0x08);
}
...
{
	FSMC_WriteReg_ANDMask(0x40,0xFD);
}
...
{
	FSMC_WriteReg_ORMask(0x40,0x02);
}
...
{
	FSMC_WriteReg_ANDMask(0x40,0xFE);
}
...
{
	FSMC_WriteReg_ORMask(0x40,0x01);
}
...
{
	FSMC_WriteReg_ANDMask(0x41,0x7F);
}
...
{
	FSMC_WriteReg_ORMask(0x41,0x80);
}
...
{
	FSMC_WriteReg_ANDMask(0x41,0x8F);
}
...
{
	FSMC_WriteReg_ANDORMask(0x41,0x8F,0x10);
}
...
{
	FSMC_WriteReg_ANDORMask(0x41,0x8F,0x20);
}
...
{
	FSMC_WriteReg_ANDORMask(0x41,0x8F,0x30);
}
...
{
	FSMC_WriteReg_ANDORMask(0x41,0x8F,0x40);
}
...
{
	FSMC_WriteReg_ANDORMask(0x41,0x8F,0x50);
}
...
{
	FSMC_WriteReg_ANDORMask(0x41,0x8F,0x60);
}
...
{
	FSMC_WriteReg_ANDORMask(0x41,0x8F,0x70);
}
...
{
	FSMC_WriteReg_ANDMask(0x41,0xF3);
}
...
{
	FSMC_WriteReg_ANDORMask(0x41,0xF3,0x04);
}
...
{
	FSMC_WriteReg_ANDORMask(0x41,0xF3,0x08);
}
...
{
	FSMC_WriteReg_ANDORMask(0x41,0xF3,0x0C);
}
...
{
	FSMC_WriteReg_ANDMask(0x41,0xFE);
}
...
{
	FSMC_WriteReg_ORMask(0x41,0x01);
}
...
{
	FSMC_WriteReg_ANDMask(0x45,0xFC);
}
...
{
	FSMC_WriteReg_ORMask(0x45,0x01);
}
...
{
	FSMC_WriteReg_ORMask(0x45,0x02);
}
...
{
	FSMC_WriteReg_ORMask(0x45,0x03);
}
...
{
	FSMC_WriteReg_ANDMask(0x50,0x7F);
}
...
{
	FSMC_WriteReg_ORMask(0x50,0x80);
}
...
{
	FSMC_WriteReg_ORMask(0x50,0x40);//BECR0
}
...
{
	FSMC_WriteReg_ANDMask(0x50,0xBF);//BECR0
}
...
{
	FSMC_WriteReg_ANDMask(0x52,0xF8);//LTPR0
}
...
{
	FSMC_WriteReg_ANDORMask(0x52,0xF8,0x01);//LTPR0
}
...
{
	FSMC_WriteReg_ANDORMask(0x52,0xF8,0x03);//LTPR0
}
...
{
	FSMC_WriteReg_ANDORMask(0x52,0xF8,0x02);//LTPR0
}
...
{
	FSMC_WriteReg_ANDORMask(0x52,0xF8,0x04);//LTPR0
}
...
{
	FSMC_WriteReg_ANDORMask(0x52,0xF8,0x05);//LTPR0
}
...
{
	FSMC_WriteReg_ANDORMask(0x52,0xF8,0x06);//LTPR0
}
...
{
	FSMC_WriteReg_ORMask(0x52,0x20);//LTPR0
}
...
{
	FSMC_WriteReg_ANDMask(0x52,0xDF);//LTPR0
}
...
{
	FSMC_WriteReg_ANDMask(0x52,0x3F);//LTPR0
...
{
	FSMC_WriteReg_ANDORMask(0x52,0x3F,0x40);//LTPR0
}
...
{
	FSMC_WriteReg_ANDORMask(0x52,0x3F,0x80);//LTPR0
}
...
{
	FSMC_WriteReg_ANDORMask(0x52,0x3F,0xC0);//LTPR0
}
...
void BTE_Source_Destination	(uint16_t XL,uint16_t XR ,uint16_t YT ,uint16_t YB)
{
    ...
    FSMC_WriteReg(0x54,XL);//HSBE0
    FSMC_WriteReg(0x55,XL>>8);//HSBE1

    FSMC_WriteReg(0x58,XR);//HDBE0
    FSMC_WriteReg(0x59,XR>>8);//HDBE1

    FSMC_WriteReg(0x56,YT);//VSBE0

    temp=YT>>8;

    //FSMC_WriteReg_ANDMask(0x57,0x80);

    temp1 = FSMC_ReadReg(0x57);
    temp1 &= 0x80;
    temp=temp|temp1;
    FSMC_WriteReg(0x57,temp);//VSBE1

    FSMC_WriteReg(0x5a,YB);//VDBE0
    temp=YB>>8;
    temp1 = FSMC_ReadReg(0x5b);
    temp1 &= 0x80;
    temp=temp|temp1;
    FSMC_WriteReg(0x5b,temp);//VDBE1
}
...
{
	FSMC_WriteReg_ANDMask(0x57,0x7F);//VSBE1
...
{
	FSMC_WriteReg_ANDMask(0x57,0x8);//VSBE1
}
...
{
	FSMC_WriteReg_ANDMask(0x5b,0X7f);//VDBE1
}
...
{
	FSMC_WriteReg_ANDMask(0x5b,0x80);//VDBE1
...
{
	FSMC_WriteReg(0x5c,X);//BEWR0
	FSMC_WriteReg(0x5d,X>>8);//BEWR1

	FSMC_WriteReg(0x5e,Y);//BEHR0
	FSMC_WriteReg(0x5f,Y>>8);//BEHR1
}
...
void Background_color(uint16_t color)
{
	...
	FSMC_WriteReg(0x60,(color&0xf800)>>11);

    FSMC_WriteReg(0x61,(color&0x07e0)>>5);

    FSMC_WriteReg(0x62,(color&0x001f));
}
...
void Foreground_color(uint16_t color)
{
	 ...
	 FSMC_WriteReg(0x63,(color&0xf800)>>11);

	 FSMC_WriteReg(0x64,(color&0x07e0)>>5);

	 FSMC_WriteReg(0x65,(color&0x001f));
}
...
{
	FSMC_WriteReg(0x60,setR);

	FSMC_WriteReg(0x61,setG);

	FSMC_WriteReg(0x62,setB);
}
...
{
	FSMC_WriteReg(0x63,setR);

	FSMC_WriteReg(0x64,setG);

	FSMC_WriteReg(0x65,setB);
...
{
	FSMC_WriteReg_ORMask(0x66,0X80);//PTNO
...
{
	FSMC_WriteReg(0x67,setR);//BGTR_R

	FSMC_WriteReg(0x68,setG);//BGTR_G

	FSMC_WriteReg(0x69,setB);//BGTR_B
}
...
void Enable_TP(void)
{
    FSMC_WriteReg_ORMask(0x70,0X80);//TPCR0
}
/*******************************************************************************
...
{
	FSMC_WriteReg_ANDMask(0x70,0X7f);//TPCR0
}
...
{
	FSMC_WriteReg_ANDMask(0x70,0Xf7);//TPCR0
...
{
	FSMC_WriteReg_ORMask(0x70,0X08);//TPCR0
}
...
{
	FSMC_WriteReg_ORMask(0x71,0x40);//TPCR1
...
{
	FSMC_WriteReg_ANDORMask(0x71,0xbf,0x04);
...
{
	FSMC_WriteReg_ANDMask(0x71,0xF0);//TPCR1
...
{
	FSMC_WriteReg_ANDORMask(0x71,0xF0,0x01);//TPCR1
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ANDORMask(0x71,0xE0,0x02);//TPCR1
}
...
{
	FSMC_WriteReg_ANDORMask(0x71,0xE0,0x03);//TPCR1
 }
...
{
    uint8_t temp;
    FSMC_WriteCmd(0x72);//TPXH	 X_coordinate high byte
    //Chk_Busy();
    temp=FSMC_DataRead();
    return temp;
}
...
{
    uint8_t temp;
    FSMC_WriteCmd(0x73);//TPYH	  Y_coordinate high byte
    //Chk_Busy();
    temp=FSMC_ReadData();
    return temp;
}
...
{
    uint8_t temp;
    FSMC_WriteCmd(0x74);//TPXYL	  uint8_t[3:2] Y_coordinate low byte  uint8_t[1:0] X_coordinate low byte
    temp=FSMC_ReadData();
    return temp;
}
...
{
	FSMC_WriteReg(0x80,X);
	FSMC_WriteReg(0x81,X>>8);

	FSMC_WriteReg(0x82,Y);
	FSMC_WriteReg(0x83,Y>>8);
}
...
{
	FSMC_WriteReg(0x84,setx);
}

void Graphic_Cursor_Color_1(uint8_t setx)
{
	FSMC_WriteReg(0x85,setx);
}
...
{
	FSMC_WriteReg_ORMask(0x8a,0x80);//P1CR
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ANDMask(0x8a, 0x7f);//P1CR
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ANDMask(0x8a, 0xbf);//P1CR
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ORMask(0x8a, 0x40);//P1CR
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	 FSMC_WriteReg_ANDMask(0x8a, 0xef);//P1CR
 }
 /*******************************************************************************
 * Function Name  : Pattern_Set_16x16
 * Description    :
...
{
	 FSMC_WriteReg_ORMask(0x8a, 0x10);//P1CR
 }
 /*******************************************************************************
 * Function Name  : Pattern_Set_16x16
 * Description    :
...
{
	FSMC_WriteReg_ORMask(0x8c, 0x80);//MCLR
 }
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ANDMask(0x8c, 0x7f);//MCLR
 }
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ANDMask(0x8c, 0xbf);//MCLR
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ORMask(0x8c, 0x40);//MCLR
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	 FSMC_WriteReg_ANDMask(0x8c, 0xef);//MCLR
 }
 /*******************************************************************************
 * Function Name  : Pattern_Set_16x16
 * Description    :
...
{
	  FSMC_WriteReg_ORMask(0x8c, 0x10);//MCLR
 }
  /*******************************************************************************
  * Function Name  : Pattern_Set_16x16
  * Description    :
...
{
	FSMC_WriteReg_ANDMask(0x8e,0x7f);
}
/*******************************************************************************
...
{
	FSMC_WriteReg_ORMask(0x8e,0x80);
	Chk_Busy();
}
/*******************************************************************************
* Function Name  : Clear_Full_Window
* Description    :
* Input          : None
* Output         : None
* Return         : None
...
{
	FSMC_WriteReg_ANDMask(0x8e,0xbf);
}
/*******************************************************************************
* Function Name  : Clear_Active_Window
* Description    :
* Input          : None
* Output         : None
* Return         : None
...
{
	FSMC_WriteReg_ORMask(0x8e,0x40);
}
...
{
	FSMC_WriteReg(0x91,X);
	FSMC_WriteReg(0x92,X>>8);

	FSMC_WriteReg(0x93,Y);
	FSMC_WriteReg(0x94,Y>>8);

	FSMC_WriteReg(0x95,X1);
	FSMC_WriteReg(0x96,X1>>8);

	FSMC_WriteReg(0x97,Y1);
	FSMC_WriteReg(0x98,Y1>>8);
}
...
{
	FSMC_WriteReg(0x99,X);
	FSMC_WriteReg(0x9a,X>>8);

	FSMC_WriteReg(0x9b,Y);
	FSMC_WriteReg(0x9c,Y>>8);

	FSMC_WriteReg(0x9d,R);
}
//---------------------------------------------//
//																						REG[A0h]
/*******************************************************************************
...
{
	FSMC_WriteReg_ANDORMask(0xA0,0x1F,0x90);
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ANDORMask(0xA0,0x1F,0xD0);
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg(0xA5,X);
	FSMC_WriteReg(0xA6,X>>8);

	FSMC_WriteReg(0xA7,Y);
	FSMC_WriteReg(0xA8,Y>>8);

	FSMC_WriteReg(0xA1,ELL_A);
	FSMC_WriteReg(0xA2,ELL_A>>8);

	FSMC_WriteReg(0xA1,ELL_A);
	FSMC_WriteReg(0xA2,ELL_A>>8);

	FSMC_WriteReg(0xA3,ELL_B);
	FSMC_WriteReg(0xA4,ELL_B>>8);
...
void Circle_Square_Coordinate_setting(uint16_t X0,uint16_t Y0 ,uint16_t X1 ,uint16_t Y1 ,uint16_t ELL_A,uint16_t ELL_B)
{
	...
	FSMC_WriteReg(0x91,X0);
	FSMC_WriteReg(0x92,X0>>8);

	FSMC_WriteReg(0x93,Y0);
	FSMC_WriteReg(0x94,Y0>>8);
...
{
	FSMC_WriteReg(0x91,P1_X);
	FSMC_WriteReg(0x92,P1_X>>8);

	FSMC_WriteReg(0x93,P1_Y);
	FSMC_WriteReg(0x94,P1_Y>>8);

	FSMC_WriteReg(0x95,P2_X);
	FSMC_WriteReg(0x96,P2_X>>8);

	FSMC_WriteReg(0x97,P2_Y);
	FSMC_WriteReg(0x98,P2_Y>>8);

	FSMC_WriteReg(0xA9,P3_X);
	FSMC_WriteReg(0xAA,P3_X>>8);

	FSMC_WriteReg(0xAB,P3_Y);
	FSMC_WriteReg(0xAC,P3_Y>>8);
...
{
	FSMC_WriteReg(0xb0,set_address);

	FSMC_WriteReg(0xb1,set_address>>8);

	FSMC_WriteReg(0xb2,set_address>>16);

	FSMC_WriteReg(0xb3,set_address>>24);
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg(0xb4,set_size);

	FSMC_WriteReg(0xb6,set_size>>8);

	FSMC_WriteReg(0xb8,set_size>>16);
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg(0xb4,BWR);
	FSMC_WriteReg(0xb5,BWR>>8);

	FSMC_WriteReg(0xb6,BHR);
	FSMC_WriteReg(0xb7,BHR>>8);

	FSMC_WriteReg(0xb8,SPWR);
	FSMC_WriteReg(0xb9,SPWR>>8);
...
{
	FSMC_WriteReg_ORMask(0xbf,0x01);
}
...
{
	FSMC_WriteReg_ORMask(0xc0,0x80);
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ANDORMask(0xc0,0x80, setx&0x07);
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ORMask(0xc0,0x40);
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ORMask(0xc1,0x80);
}
/*******************************************************************************
* Function Name  : Pattern_Set_16x16
* Description    :
...
{
	FSMC_WriteReg_ORMask(0xc1,setx&0x1c);
...
{
	FSMC_WriteReg(0xd0,X);
    FSMC_WriteReg(0xd1,X>>8);

    FSMC_WriteReg(0xd2,Y);
    FSMC_WriteReg(0xd1,X>>8);
}
...
void Floating_window_size(uint16_t width_X,uint16_t high_Y)
{
	...
	FSMC_WriteReg(0xd4,width_X);
	FSMC_WriteReg(0xd5,width_X>>8);

	FSMC_WriteReg(0xd6,high_Y);
	FSMC_WriteReg(0xd7,high_Y>>8);
}
...
{
	FSMC_WriteReg(0xd8,X);
	FSMC_WriteReg(0xd9,X>>8);

	FSMC_WriteReg(0xda,Y);
	FSMC_WriteReg(0xdb,Y>>8);
}
...
void DMA_Address_32bits(uint32_t set_address)
{
  ...
  FSMC_WriteReg(0xE1,set_address>>24);
  FSMC_WriteData(set_address>>16);
  FSMC_WriteData(set_address>>8);
  FSMC_WriteData(set_address);
...
void DAM_Address_24bits(uint32_t set_address)
{
  ...
  FSMC_WriteReg(0xE1,set_address>>16);
  FSMC_WriteReg(0xE1,set_address>>8);
  FSMC_WriteReg(0xE1,set_address);
}
...
{
	FSMC_WriteReg_ORMask(0xf0,0x10);
}
...
{
	FSMC_WriteReg_ANDMask(0xf0,0x0f);
}
...
{
	FSMC_WriteReg_ORMask(0xf0,0x08);
}
...
{
	FSMC_WriteReg_ANDMask(0xf0,0x17);
}
...
{
	FSMC_WriteReg_ORMask(0xf0,0x04);
}
...
{
	FSMC_WriteReg_ANDMask(0xf0,0x1b);
}
...
{
	FSMC_WriteReg_ORMask(0xf0,0x02);
}
...
{
	FSMC_WriteReg_ANDMask(0xf0,0x1d);
}
...
{
	FSMC_WriteReg_ORMask(0xf0,0x01);
}
...
{
	FSMC_WriteReg_ANDMask(0xf0,0x1E);
}
...
{
	FSMC_WriteReg_ORMask(0xf1,0x10);
...
uint8_t Keyscan_Status(void)
{
  ...
  uint8_t temp = FSMC_ReadReg(0xf1);
  if ((temp&0x10)==0x10)
     return 1;
  else
     return 0;
...
{
	FSMC_WriteReg_ORMask(0xf1,0x08);
}
...
{
	FSMC_WriteReg_ORMask(0xf1,0x04);
}
...
{
	FSMC_WriteReg_ORMask(0xf1,0x02);
}
...
{
	FSMC_WriteReg_ORMask(0xf1,0x01);
}
